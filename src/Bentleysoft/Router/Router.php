 ...
 * Time: 07:34
 */
namespace Bentleysoft\Router;

/**
 * Class Router.
 *
 * This is very much inspired and adapted from Bram(us) Van Damme's
 * excellent little Router package.
 * No additions have been made to his code but the codebase is adapted to one
 * that can be used straight away as a dtop in blank mini project skeleton
 * There are however plans to implement a whole range of API specific verb handling helpers
 *
 */
class Router
{
